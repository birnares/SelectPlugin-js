...
var getTemplate = function getTemplate() {
  ...
  var text = placeholder !== null && placeholder !== void 0 ? placeholder : "Placeholder по умолчанию не задан";
  var items = data.map(function (item) {
    ...
    return "<li class=\"select__item ".concat(cls, "\" data-type=\"item\" data-id=\"").concat(item.id, "\">").concat(item.name, "</li>");
  });
  return "\n        <div class=\"select__backdrop\" data-type=\"backdrop\"></div>\n        <div class=\"select__input\" data-type=\"input\">\n        <span data-type=\"value\">".concat(text, "</span>\n            <i class=\"fa-solid fa-angle-down\" data-type=\"arrow\"></i>\n        </div>\n        <div class=\"select__dropdown\">\n            <ul class=\"select__list\">\n                ").concat(items.join(""), "\n            </ul>\n        </div>\n    ");
};
...
var Select = /*#__PURE__*/function () {
  ...
  _createClass(Select, [{
    ...
    value: function toggle() {
      this.isOpen ? this.close() : this.open(); // проверка на открытие выпадающего списка
    }
  }, {
    key: "open",
    value: function open() {
...
function _setup2() {
  this.clickHandler = this.clickHandler.bind(this); // для использования ниже в сочетании с this
...
window.s = select;
},{"./select/select.js":"select/select.js","./select/style.scss":"select/style.scss"}],"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
